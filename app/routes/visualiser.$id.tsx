...
const VisualiserId = () => {
  ...
  useEffect(() => {
    // ✅ redirect if navigated here directly with no state
    if (!initialImage) {
    ...
    // ✅ set initial render if available, then ALWAYS run generation
    if (initialRender) {
      setCurrentImage(initialRender);
    }

    runGeneration(); // ← now always runs regardless of initialRender
